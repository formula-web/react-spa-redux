//Fichero con datos generales de configuracion 
...
export default {
    ...
    servidorVideos:   'http://localhost:3002',   //servidor http "static" en el directorio uploads donde sube los videos el servicio video api
